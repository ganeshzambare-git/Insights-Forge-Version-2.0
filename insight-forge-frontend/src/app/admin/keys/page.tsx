...
import { KeyRotationPage } from '../../../features/administration/keyRotation/components/KeyRotationPage';
  ...
  const MismatchFallback = (
    <div style={{
      ...
      <p style={{ color: 'var(--muted)', maxWidth: '440px', marginBottom: '2rem', fontSize: '0.95rem', lineHeight: '1.5' }}>
        You do not have administrative clearance to access key rotation parameters.
      </p>
      <button 
      ...
      <main style={{ minHeight: '100vh', backgroundColor: 'var(--bg)', color: 'var(--ink)' }}>
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <span style={{ fontWeight: 800, color: 'var(--brand)' }}>SSO Secrets Manager</span>
