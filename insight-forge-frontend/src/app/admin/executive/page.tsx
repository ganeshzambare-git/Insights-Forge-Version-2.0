...
export default function ExecutiveAnalyticsPage() {
  ...
  return (
    <RoleGuard allowedRoles={['Admin', 'Dean']} fallback={MismatchFallback}>
      <main style={{ minHeight: '100vh', backgroundColor: 'var(--bg)', color: 'var(--ink)', paddingBottom: '3rem' }}>
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <span style={{ fontWeight: 800, color: 'var(--brand)' }}>Dean Decision Portal</span>
            <span style={{ fontSize: '0.75rem', color: 'var(--violet)', border: '1px solid var(--violet)', borderRadius: '0.25rem', padding: '0.125rem 0.375rem', textTransform: 'uppercase', fontWeight: 700 }}>
              Dean-1 Canvas
            </span>
          </div>
          <button 
        ...
        <hr style={{ border: 'none', borderTop: '1px solid var(--border)', margin: '1rem 2.5rem' }} />
