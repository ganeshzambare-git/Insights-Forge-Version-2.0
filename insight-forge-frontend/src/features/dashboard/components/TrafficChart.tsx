      ...
      <svg viewBox={`0 0 ${svgWidth} ${svgHeight}`} width="100%" height="auto" style={{ overflow: 'visible' }}>
        <defs>
          <linearGradient id="areaGradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#2f7d97" stopOpacity="0.4" />
            <stop offset="100%" stopColor="#2f7d97" stopOpacity="0.0" />
          </linearGradient>
        </defs>
        ...
        {/* Area border line */}
        <path d={strokePath} fill="none" stroke="#2f7d97" strokeWidth="3" />
