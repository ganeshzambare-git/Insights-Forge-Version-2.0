...
const STATUS_CONFIG: Record<TaskStatus, { label: string; color: string; bg: string; icon: string }> = {
  Pending:   { label: 'Pending',   color: 'var(--muted)', bg: 'rgba(148,163,184,0.1)', icon: '⏳' },
  Running:   { label: 'Running',   color: 'var(--brand)', bg: 'rgba(56,189,248,0.1)',  icon: '' },
  Completed: { label: 'Completed', color: 'var(--safe)', bg: 'rgba(52,211,153,0.1)',  icon: '' },
  Failed:    { label: 'Failed',    color: 'var(--critical)', bg: 'rgba(248,113,113,0.1)', icon: '' },
};
